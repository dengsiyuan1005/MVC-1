...
var n = localStorage.getItem('n'); //初始化number值
$number.text(n || 100); //number是n或者100
$button1.on('click', function () {
    var n = parseInt($number.text());
    n += 1;
    localStorage.setItem('n', n); //把值存起来
    $number.text(n);
});
...
var $tabBer = (0, _jquery2.default)('#app2 .tab-bar');
var $tabContent = (0, _jquery2.default)('#app2 .tab-content');

$tabBer.on('click', 'li', function (e) {
    var $li = (0, _jquery2.default)(e.currentTarget);
    $li.addClass('selected').siblings().removeClass('selected');
    var index = $li.index();
    $tabContent.children().eq(index).addClass('active').siblings().removeClass('active'); //他的兄弟删除active
});
...
var $squere = (0, _jquery2.default)('#app3 .square');
...
require('./app4.js');
},{"./reset.css":"reset.css","./app1.js":"app1.js","./global.css":"global.css","./app2.js":"app2.js","./app3.js":"app3.js","./app4.js":"app4.js"}],"C:\\Users\\sss\\AppData\\Local\\Yarn\\Data\\global\\node_modules\\parcel\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/main.42db4fd6.map